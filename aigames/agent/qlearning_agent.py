...
class QLearningAgent(Agent):
    def __init__(self, game: Type[PartiallyObservableSequentialGame], player_index,
                 ...
                 data_listener: QLearningDataListener, exploration_probability, discount_rate):
        self.game = game
        ...
        self._exploration_probability = exploration_probability  # save this here so that we can switch exploration_probability on and off and remember what the exploration probability was
    ...
    def train(self):
        self.training = True
        self.exploration_probability = self._exploration_probability
