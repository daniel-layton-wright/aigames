...
from .network_architectures import Connect4Network, Connect4Evaluator
import torch
...
class AlphaTrainingRunLightningConnect4(AlphaTrainingRunLightning):
    ...
    def on_train_epoch_end(self) -> None:
        ...
        avg_reward_against_minimax = play_tournament_old(Connect4, [agent, more_mcts_agent], 100, 1)
